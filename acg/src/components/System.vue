...
<div class="background">
    <div>
    <img v-if="list" id='img' :src="img" @click=" userinfo"/>
    <label v-if="!list" @click="exit2">请登录</label>
...
export default {
  data () {
    return {
      navList: [
        {name: '/System/Home', navItem: 'A网首页'},
        {name: '/System/User', navItem: '我的A宝'}
      ],
      password: '',
      password2: '',
      newpassword: '',
  ...
  methods: {
    ...
    exit () {
      this.axios.post('/api/demo/ShoppingCart/deleteSession').then(rse => {
